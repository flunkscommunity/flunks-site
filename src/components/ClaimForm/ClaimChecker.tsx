...
const ClaimChecker: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <P>
          If you have a student serial number, you can use this tab to
          check if a backpack has been claimed from the lost and found. Simply
          enter your serial number in the designated field and hit the "Search"
