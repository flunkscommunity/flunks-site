...
const ItemsGrid: React.FC = () => {
  ...
  const [viewType, setViewType] = useState<"grid" | "table">("grid" as const);
          ...
          <Frame variant="field" className="!w-full">
            ...
            <div className="flex w-full">
              <Frame
                ...
                className="w-full px-3 py-1 !flex justify-between"
              >
                <span className="text-lg">$GUM</span>
                <span className="text-lg font-bold">
                  {Number(gumBalance || 0)?.toFixed(5)}
                </span>
              </Frame>
              <Frame
                variant="well"
          ...
          >
            <Select
              ...
              options={[
                ...
                { value: 1, label: "Flunks" },
                { value: 2, label: "Backpacks" },
              ]}
              width={140}
              onChange={(e) => {
            ...
            <div className="h-full flex gap-1">
              <Button
                ...
                disabled={viewType === "grid" || noItems}
                active={!noItems && viewType === "grid"}
                size="lg"
                className="group"
              >
                <img
              ...
              <Button
                ...
                disabled={viewType === "table" || noItems}
                active={!noItems && viewType === "table"}
                size="lg"
                className="group"
              >
                <img
