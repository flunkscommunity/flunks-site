...
('floating_button', 5, 1, 100, 'Floating gum button clicks'),
('daily_login', 25, 1440, 25, 'Daily login bonus'),
('feature_usage', 3, 30, 50, 'Using site features'),
('special_event', 50, 0, NULL, 'Special event rewards');
